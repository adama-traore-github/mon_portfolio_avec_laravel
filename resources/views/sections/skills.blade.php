<section id="skills" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 min-h-screen flex flex-col justify-center scroll-mt-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-24">
        <!-- Langages -->
        <div class="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 hover:border-blue-500 transition-all hover:shadow-lg hover:shadow-blue-500/10">
        ...
        <!-- Frameworks -->
        <div class="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 hover:border-green-500 transition-all hover:shadow-lg hover:shadow-green-500/10">
        ...
        <!-- Blockchain -->
        <div class="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 hover:border-purple-500 transition-colors">
        ...
        <!-- Bases de données -->
        <div class="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 hover:border-emerald-500 transition-colors">
        ...
        <!-- Outils -->
        <div class="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 hover:border-cyan-500 transition-all hover:shadow-lg hover:shadow-cyan-500/10">
        ...
        <!-- Process -->
        <div class="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 hover:border-purple-500 transition-all hover:shadow-lg hover:shadow-purple-500/10">
            <h3 class="text-xl font-bold text-purple-400 mb-6 flex items-center">
                <svg class="w-6 h-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:bg-slate-800 transition-colors">
