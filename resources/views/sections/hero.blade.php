        ...
        <div class="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-24">
            ...
            <div class="w-full lg:w-1/2 text-center lg:text-left">
                <h1 class="text-5xl sm:text-6xl md:text-7xl font-extrabold text-white leading-[1.1] mb-6 tracking-tight">
                    Développeur <br/>
                    Full-Stack <br/>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Professionnel</span>
                </h1>

                <p class="text-lg text-slate-300 mb-8 max-w-lg mx-auto lg:mx-0">
                    Création de solutions web sur mesure avec les dernières technologies pour des performances optimales.
                </p>

                <div class="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
                    <!-- Modern Blue Button -->
                    <a href="#projets" class="px-8 py-4 bg-[#0ea5e9] hover:bg-[#0284c7] text-white rounded-full font-bold transition-all shadow-[0_4px_14px_0_rgba(14,165,233,0.39)] hover:shadow-[0_6px_20px_rgba(14,165,233,0.23)] hover:-translate-y-0.5 w-full sm:w-auto">
                        Voir mes réalisations
                    </a>
                    
                    <!-- Outline Button -->
                    <a href="#contact" class="px-8 py-4 rounded-full text-slate-300 border border-slate-700 hover:border-cyan-500 hover:text-white transition-all font-medium w-full sm:w-auto">
            ...
            <div class="w-full lg:w-1/2 flex justify-center lg:justify-end mt-12 lg:mt-0">
                <div class="relative w-80 h-80 sm:w-[400px] sm:h-[400px] lg:w-[500px] lg:h-[500px]">
                    <!-- Main Image Circle with Cyan Glow Border -->
                    <div class="relative w-full h-full rounded-full p-[3px] bg-gradient-to-b from-cyan-400 to-cyan-400/20 shadow-[0_0_40px_rgba(34,211,238,0.3)]">
                        <div class="w-full h-full rounded-full overflow-hidden bg-slate-900 relative z-10">
                             <img 
                    ...
                    <div class="absolute bottom-[10%] -left-[5%] z-20 animate-bounce-slow">
                        <div class="bg-black/80 border border-cyan-500/30 rounded-xl py-3 px-5 flex items-center gap-3 shadow-lg backdrop-blur-md">
                            ...
                            <div class="flex flex-col">
                                <span class="text-xs text-cyan-400 uppercase tracking-wider font-medium">Disponible</span>
